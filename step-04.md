...
几年以前，因为钻研 Growth Hack，需要研究许多营销书籍，我意外的从 Google Books 里面发现，现代营销的经典洗脑框架，PPPP（注1）。这种写作的技巧，原来 100
...
![图片](./image-step-04/media/image3.png)

Netflix 剛創業時的角度，從消費者的痛點切入：

![图片](./image-step-04/media/image4.png)

-   需要开车去租片 =\> 可以请 Netflix 寄给租片者，并且可以邮寄返还
-   店里面租不到冷门片 =\> Netflix 租得到
-   逾期宽限时间短 =\> 逾期宽限时间长

![图片](./image-step-04/media/image5.png)
...
![图片](./image-step-04/media/image6.png)
这一步棋彻底解决了消费者的痛点。
...
![图片](./image-step-04/media/image7.png)
-   消费者租片能够更快，随时随地都能看片
...
![图片](./image-step-04/media/image8.png)
...
![图片](./image-step-04/media/image9.png)
小龙虾炒饭
